...
describe('i18n locale key consistency', () => {
  ...
  it('all locales have the file organization setting keys', () => {
    for (const locale of [en, ptBR, es]) {
      ...
      expect(locale.settings).toHaveProperty('organizeByAlbum')
      expect(locale.settings).toHaveProperty('organizeByAlbumHint')
    }
  })
