export default {
  ...
  search: {
    ...
    emptyFilterHint: 'Tente mudar o filtro acima para Tudo ou outro tipo.',
    filterLabel: 'Tipo de resultado',
    filterBoth: 'Tudo',
    sectionArtists: 'Artistas',
    sectionAlbums: 'Álbuns',
  ...
  metadata: {
    ...
    dupeTab: 'Duplicados',
    dupeSubtitle:
      'Encontre faixas que aparecem mais de uma vez e remova as copias extras. O arquivo maior ou lossless e mantido por padrao.',
    scanDuplicates: 'Buscar duplicados',
    scanningDuplicates: 'Buscando duplicados...',
    dupeEmpty: 'Nenhuma faixa duplicada encontrada.',
    dupeGroups: 'Grupos duplicados',
    dupeExtra: 'Copias extras',
    dupeKeep: 'Manter',
    dupeRemove: 'Remover',
    dupeAlbum: 'Album',
    dupeSize: 'Tamanho',
    dupeDeleteSelected: 'Excluir copias selecionadas',
    dupeDeleting: 'Excluindo...',
    dupeDeleteConfirm:
      'Excluir {count} arquivo(s) duplicado(s)? Isso nao pode ser desfeito.',
    dupeDeleteOk: 'Removidos {count} arquivo(s) duplicado(s).',
    dupeDeletePartial:
      'Removidos {deleted} arquivo(s); {failed} nao puderam ser excluidos.',
    dupeScanFailed: 'Falha ao buscar duplicados.',
    dupeDeleteFailed: 'Falha ao excluir duplicados.',
    ...
    albumImagesLibraryEmpty: 'Nenhum album baixado encontrado.',
    artistAlbumCount: '{count} albuns',
    searchAlbumImageArtists: 'Buscar artistas ou albuns',
    emptyAlbumImageArtistSearch: 'Nenhum artista ou album correspondente.',
    clearSearch: 'Limpar busca',
    ...
    chooseAlbumCoverTitle: 'Escolher capa do album',
    chooseCoverHint:
    ...
    chooseAlbumCoverEmpty:
      'Nenhuma opção de capa foi encontrada para este album.',
  ...
  monitor: {
    ...
    kindArtist: 'Artista',
    urlPlaceholderPlaylist: 'Busque playlists do Spotify ou cole uma URL...',
    ...
    checkAll: 'Verificar agora todos os itens monitorados',
  ...
  settings: {
    ...
    generalTab: 'Geral',
    monitorArtistInitialSearch: 'Primeira busca do artista monitorado',
    monitorArtistInitialSearchHint:
      'Buscar automaticamente álbuns e faixas ao monitorar um artista.',
    apiTab: 'API',
    logsTab: 'Registros',
    aboutTab: 'Sobre',
    helpTab: 'Ajuda',
  ...
  player: {
    ...
    lyrics: 'Letras',
    lyricsOffset: 'Tempo das letras',
    lyricsEarlier: 'Mostrar letras antes',
    lyricsLater: 'Mostrar letras depois',
    lyricsReset: 'Redefinir tempo das letras',
    volume: 'Volume',
    mute: 'Mudo',
    unmute: 'Tirar mudo',
    nowPlaying: 'Tocando agora',
    upNext: 'A seguir',
    queueEmpty: 'Não há outras faixas nesta fila.',
    ...
    similarMedia: 'Mídia semelhante',
    similarTracksEmpty: 'Nenhuma faixa semelhante encontrada.',
    trackDetails: 'Detalhes da faixa',
    releaseYear: 'Ano de lançamento',
    durationLabel: 'Duração',
    queuePosition: 'Posição na fila',
    albumCompleteness: '{have} de {total} faixas na biblioteca',
    albumMissingShort: '{count} faltando',
    albumComplete: 'Completo',
    matchingAlbums: 'Álbuns correspondentes',
    viewAlbumTracks: 'Faixas',
    albumDownloaded: 'Álbum baixado',
    albumNotDownloaded: 'Não está na biblioteca',
    albumTracksOwnedSummary: '{have} de {total} faixas baixadas',
    albumTracksMissingSummary: '{count} faltando',
    missingTrack: 'Faltando',
    albumTracksUnavailable: 'Não foi possível carregar as faixas deste álbum.',
    downloadAlbum: 'Baixar álbum',
    downloadMissing: 'Baixar faltantes',
    downloadMissingAlbum: 'Baixar faixas faltantes do álbum',
    noMatchingAlbums: 'Nenhum álbum online correspondente encontrado.',
  ...
  artist: {
    title: 'Artista',
    subtitle: 'Álbuns e singles para baixar ou monitorar.',
    empty: 'Nenhum álbum encontrado para este artista.',
    loadError: 'Não foi possível carregar este artista.',
  },
  footer: {
