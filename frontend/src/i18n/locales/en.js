export default {
  ...
  search: {
    ...
    emptyFilterHint: 'Try switching the filter above to All or another type.',
  ...
  metadata: {
    ...
    dupeTab: 'Dupe Check',
    dupeSubtitle:
      'Find tracks that appear more than once and remove the extra copies. The larger or lossless file is kept by default.',
    scanDuplicates: 'Scan duplicates',
    scanningDuplicates: 'Scanning duplicates...',
    dupeEmpty: 'No duplicate tracks found.',
    dupeGroups: 'Duplicate groups',
    dupeExtra: 'Extra copies',
    dupeKeep: 'Keep',
    dupeRemove: 'Remove',
    dupeAlbum: 'Album',
    dupeSize: 'Size',
    dupeDeleteSelected: 'Delete selected copies',
    dupeDeleting: 'Deleting...',
    dupeDeleteConfirm:
      'Delete {count} duplicate file(s)? This cannot be undone.',
    dupeDeleteOk: 'Removed {count} duplicate file(s).',
    dupeDeletePartial:
      'Removed {deleted} file(s); {failed} could not be deleted.',
    dupeScanFailed: 'Failed to scan for duplicates.',
    dupeDeleteFailed: 'Failed to delete duplicates.',
  ...
  settings: {
    ...
    connectionModeDeviceHint:
      'Search and downloads run on this phone (local engine at 127.0.0.1). This is not your Docker or Cloudflare server.',
  ...
  artist: {
    title: 'Artist',
    subtitle: 'Albums and singles you can download or monitor.',
    empty: 'No albums found for this artist.',
    loadError: 'Could not load this artist.',
  },
  footer: {
