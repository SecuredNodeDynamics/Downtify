export default {
  ...
  auth: {
    ...
    pin: 'PIN',
    showSecret: 'Mostrar {name}',
    hideSecret: 'Ocultar {name}',
    createAdmin: 'Crear perfil de administrador',
    signIn: 'Entrar',
    signOut: 'Salir',
    signedInAs: 'Sesión iniciada como',
    switchProfile: 'Cambiar de perfil',
    accounts: 'Cuentas',
    familyAccounts: 'Perfiles familiares',
  ...
  search: {
    ...
    emptyArtists: 'No se encontraron artistas.',
    emptyTracks: 'No se encontraron pistas.',
    emptyFilterHint: 'Prueba cambiar el filtro de arriba a Todos u otro tipo.',
    ...
    downloadRemaining: 'Descargar restantes',
    downloadTrack: 'Descargar pista',
    queueAlbumFailed:
      'No se pudo añadir este álbum a la cola. Inténtalo de nuevo.',
    demo: 'Demo',
  ...
  library: {
    ...
    artistAlbumsTab: 'Álbumes',
    artistDownloadTab: 'Descargar',
    ...
    updateGenres: 'Actualizar generos',
    updatingGenres: 'Buscando generos…',
    updatingGenresLibrary: 'Leyendo la biblioteca…',
    updatingGenresProgress: 'Buscando generos… {current} de {total}',
    updatingGenresStalled:
      'Sigue en marcha. Una consulta esta tardando mas de lo habitual.',
    cancelGenreUpdate: 'Detener',
    genreUpdateCancelled:
      'Se detuvo la actualizacion de generos. Puedes reanudarla.',
    genreUpdateFailed: 'Fallo la actualizacion de generos. Puedes reintentar.',
    genreUpdateComplete: 'Actualizadas {tagged} de {total} pistas.',
    unknownGenreHint:
      '{count} pistas aun no tienen genero. Actualiza las categorias al anadir musica nueva.',
    genresUpdated: 'Las categorias de genero estan al dia.',
  ...
  metadata: {
    ...
    dupeTab: 'Duplicados',
    dupeSubtitle:
      'Encuentra canciones que aparecen mas de una vez y elimina las copias extra. Se conserva el archivo mas grande o sin perdida.',
    scanDuplicates: 'Buscar duplicados',
    scanningDuplicates: 'Buscando duplicados...',
    dupeEmpty: 'No se encontraron canciones duplicadas.',
    dupeGroups: 'Grupos duplicados',
    dupeExtra: 'Copias extra',
    dupeKeep: 'Conservar',
    dupeRemove: 'Eliminar',
    dupeAlbum: 'Album',
    dupeSize: 'Tamano',
    dupeDeleteSelected: 'Eliminar copias seleccionadas',
    dupeDeleting: 'Eliminando...',
    dupeDeleteConfirm:
      'Eliminar {count} archivo(s) duplicado(s)? Esto no se puede deshacer.',
    dupeDeleteOk: 'Se eliminaron {count} archivo(s) duplicado(s).',
    dupeDeletePartial:
      'Se eliminaron {deleted} archivo(s); {failed} no se pudieron eliminar.',
    dupeScanFailed: 'No se pudieron buscar duplicados.',
    dupeDeleteFailed: 'No se pudieron eliminar los duplicados.',
  ...
  settings: {
    ...
    serverConnectionHint:
      'Guarda una direccion de red local (IP) y una URL publica (Cloudflare) para cambiar sin volver a escribir. Dejalas vacias si usas el navegador en el mismo host que el servidor.',
    modeSection: 'Modo',
    connectionModeDevice: 'Ejecutar en este dispositivo',
    connectionModeServer: 'Conectar a un servidor',
    connectionModeDeviceHint:
      'Downtify se ejecuta totalmente en este dispositivo: la busqueda y las descargas funcionan sin ningun servidor. 127.0.0.1 es el motor local del telefono, no tu servidor Docker o Cloudflare.',
    connectionModeServerHint:
      'Usa tu servidor Downtify: IP de LAN (por ejemplo 10.128.1.63:8000) o una URL publica como un tunel de Cloudflare.',
    connectionModeServerConfigHint:
      'Configura la direccion del servidor en Ajustes → API.',
    connectionModeServerFamilyHint:
      'Un administrador configura la IP local y Cloudflare en Ajustes → API. Los perfiles familiares pueden cambiar entre este dispositivo y ese servidor guardado.',
    ...
    serverRequiredHint:
      'La app movil necesita la direccion del servidor antes de cargar cola, salud y otros datos. Abre Ajustes e introduce tu IP local, la URL de Cloudflare, o ambas.',
    serverRequiredHintFamily:
      'Un administrador debe guardar la direccion del servidor en Ajustes → API. Cambia a «Ejecutar en este dispositivo» o pide a un administrador que configure la IP local o Cloudflare.',
    ...
    serverSaveHint:
      'Usa Conectar a este dispositivo si ya estas navegando Downtify en el servidor. Guarda una IP local y una URL de Cloudflare, luego cambia con Red local / Cloudflare y Guardar direccion. La app se recarga al conectar.',
  ...
  artist: {
    title: 'Artista',
    subtitle: 'Álbumes y singles para descargar o monitorear.',
    empty: 'No se encontraron álbumes de este artista.',
    loadError: 'No se pudo cargar este artista.',
  },
  footer: {
