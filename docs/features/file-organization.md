...
With *Organize by artist* enabled, you can also turn on **Organize by album** to nest tracks one level deeper under the album name:
...
Tracks without album metadata are placed in an `Unknown Album` folder. The album option has no effect unless *Organize by artist* is also enabled.
